...
import (
	...
	"hive/pkg/db/redis"
	"hive/pkg/logger"
	"hive/services/store/internal/config"
	"hive/services/store/internal/interceptor"
	repoRedis "hive/services/store/internal/repository/redis"
	"hive/services/store/internal/service"
	transportGrpc "hive/services/store/internal/transport/grpc"
	"net"
...
func New(cfg *config.Config, lg logger.Logger) (*App, error) {
	...
	storeServer := transportGrpc.NewServer(
		storeService,
